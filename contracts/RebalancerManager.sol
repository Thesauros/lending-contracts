...
contract RebalancerManager is IRebalancerManager, GliaAccessControl {
  ...
  /// @inheritdoc IRebalancerManager
  function allowExecutor(address executor, bool allowed) external override onlyAdmin {
   ...
   */
  function _checkAssetsAmount(IInterestVault vault, uint256 amount, IProvider from) internal view {
