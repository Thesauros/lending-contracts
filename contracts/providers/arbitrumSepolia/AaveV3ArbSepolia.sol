...
/**
 * @title AaveV3ArbSepolia
 *
 * @notice This contract allows interaction with AaveV3 on Arbitrum sepolia.
 */
contract AaveV3ArbSepolia is IProvider {
    /**
    ...
    function _getPool() internal pure returns (IPool) {
        return IPool(0xBfC91D59fdAA134A4ED45f7B584cAf96D7792Eff);
    }
