...
contract DForceArbitrum is IProvider {
  ...
  function _enterCollatMarket(address _iTokenAddress) internal {
    ComptrollerInterface controller = ComptrollerInterface(_getControllerAddress());
   ...
   */
  function _getInterestToken(address asset) internal view returns (address iToken) {
