 ...
 * @title AaveV3Binance
 *
 * @notice This contract allows interaction with AaveV3 on Binance Smart Chain.
 */
contract AaveV3Binance is IProvider {
    /**
    ...
    function _getPool() internal pure returns (IPool) {
        return IPool(0x6807dc923806fE8Fd134338EABCA509979a7e0cB);
    }
